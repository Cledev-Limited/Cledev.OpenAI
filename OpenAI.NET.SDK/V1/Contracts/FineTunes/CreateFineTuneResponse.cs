...
public record CreateFineTuneResponse
{
    ...
    public List<CreateFineTuneResponseEvent> Events { get; set; } = new();
    ...
    public List<CreateFineTuneResponseFile> ResultFiles { get; set; } = new();
    ...
    public List<CreateFineTuneResponseFile> TrainingFiles { get; set; } = new();
