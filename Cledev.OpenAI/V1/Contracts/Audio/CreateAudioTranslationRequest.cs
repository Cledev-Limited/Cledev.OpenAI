...
/// </summary>
public class CreateAudioTranslationRequest
{
    /// <summary>
    /// <para>Required.</para>
    ...
    /// <summary>
    /// <para>Optional.</para>
    /// <para>An optional text to guide the model's style or continue a previous audio segment. The prompt should be in English.</para>
    /// </summary>
